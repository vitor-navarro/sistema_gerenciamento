...
export function Services(){
    return(
        <div className={styles.servicesContainer}>
            ...
            <div style={{marginTop:"5rem"}} className={styles.servicesContent}>
                ...
                <ImageCard image='/teste projeto.png' title='Segurança eletrônica' description='Instalação e manutenção de segurança eletrônica'/>    
